...
class URLEntry(BaseModel):
    ...
    published_date: datetime | None = Field(None, description="Article publish date if known")
    ...
    is_mcp_related: bool | None = Field(None, description="Whether article is MCP-related")
    relevance_score: float | None = Field(None, ge=0.0, le=1.0, description="MCP relevance score")
