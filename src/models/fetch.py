...
class FetchResult(AnalyticsBase):
    ...
    word_count: int | None = Field(
        None, ge=0, description="Number of words in extracted content"
    )
    ...
    # Metadata
    found_in_posts: list[str] = Field(
        default_factory=list, description="Post IDs where this URL was found"
    )
