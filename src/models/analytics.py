...
class AnalyticsBase(BaseModel):
    ...
    @classmethod
    def from_frontmatter(cls, frontmatter: dict[str, Any]) -> Self:
    ...
    @classmethod
    def df_from_stage_dir(cls, stage_name: str, days_back: int = 1) -> pd.DataFrame:
        """
    ...
    @classmethod
    def df_from_files(cls, file_paths: list[Path]) -> pd.DataFrame:
        """
