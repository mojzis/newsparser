...
from src.bluesky.url_utils import (
    clean_bluesky_urls_from_links,
    extract_post_uri_from_url,
)
...
class CollectStage(InputStage):
    ...
    async def _fetch_referenced_post(self, bluesky_url: str) -> BlueskyPost | None:
        """
    ...
    async def run_collection(self, target_date: date | None = None) -> dict:
        """
